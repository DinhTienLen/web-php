                    ...
                    <div class="container">
                        <div class="row clearfix">
                            <div class="col-12 col-sm-12 col-md-6" id="header-text">
                                <a> Hưng Store </a><b> Nơi quy tụ tất cả loại giày </b>
                            </div>
                ...
                <div class="container">
                    <div class="row" id="header-main">
                        <div class="col-xs-12 col-sm-12 col-md-3" id="header-logo">
                            <a href="index.php">
                            <img src="/shoes-shop/images/hunglogo.png" alt="">
                            </a>
                        </div>
            ...
            <div id="maincontent">
                <div class="container">
                    <div class="col-md-3  fixside" >
                        ...
                        <div class="box-left box-menu">
                            <h3 class="box-title" style="margin:0px;"><i class="fa fa-list"></i>  Hàng mới về </h3>
                            <ul>
                                ...
                                <li class="clearfix">
                                    ...
                                    <div class="info pull-right" >
                                        ...
                                        <span class="view"><i class="fa fa-eye"></i>9500 : <i class="fa fa-heart-o"></i>10</span>
                                    </div>
                                </li>
                                <?php endforeach ?>
                            </ul>
                        ...
                        <div class="box-left box-menu">
                            <h3 class="box-title" style="margin:0px;"><i class="fa fa-list"></i> Hot Deal - Giảm sốc </h3>
                            <ul>
